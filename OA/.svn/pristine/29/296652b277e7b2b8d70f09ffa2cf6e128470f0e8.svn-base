...
<link href="../assets/global/plugins/jquery-file-upload/css/jquery.fileupload-ui.css" rel="stylesheet" type="text/css" />
	...
	<div style="height: 34px;line-height: 34px;"><span>附件：</span><a class="btn btn-success btn-sm" style="float: right;" href="../file/package/${formid}" >打包下载附件</a></div>
...
<script>
	var websocket = new WebSocket("wss://<%=basepath %>/ws?uid=${USER.userid}");
		    	...
		    	{orderable: false,render:function(data, type, row){
		    		return '<div class="btn-group">'
			    			...
			    			+'<ul class="dropdown-menu" role="menu">'
								...
								+((${uploadfile==true}  && ${USER.userid}==row.FCREATOR)?'<li><a href="javascript:deletefile(\''+row.FID+'\');"><span class="icon-docs"></span>删除</a></li>':'')
							+'</ul>'
						+' </div>';
		    	}}
		    ],
