    	...
    	<form id="form_bill" class="form-horizontal" role="form">
	        ...
	        <div class="form-group">
	            ...
	            <div class="col-md-10 col-md-offset-2">
	            	<textarea id="templatereason" <c:if test="${returnObject.contract.FTEMPLATE==1}">style='display: none;'</c:if> name="templatereason" class="form-control" placeholder="原因">${returnObject.contract.FTEMPLATEREASON}</textarea>
	            </div>
	        </div>
   			<div class="form-group">
...
var initvalidate = function() {
	$('#form_bill').validate({
        ...
        unhighlight: function (element) {
        	...
        	console.log(data);
        	$.post("../Contract/Save",data,function(){
