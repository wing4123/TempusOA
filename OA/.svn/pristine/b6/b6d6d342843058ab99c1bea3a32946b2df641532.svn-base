...
%>
    	<div class="form-horizontal">
    		<button class='btn btn-success pull-right' style="margin-top: -65px;" onclick="printform('${returnObject.contract.FID}')">打印</button>
			<div class="form-group">
				<div class="form-group-inline">
	        		<label class="col-md-2 control-label">标题<span class="required">*</span></label><input id="id" value="${returnObject.contract.FID}" type="hidden" />
	        		<div class="col-md-10"><input class="form-control" name="name" value="${returnObject.contract.FNAME}" readonly /></div>
        		</div>
			</div>
   			<div class="form-group">
   			...
   			<div class="form-group">
	            ...
	            <div class="col-md-10">
	                <div class="mt-radio-inline" style="padding-bottom: 0px;">
	                    ...
	                    <label class="mt-radio">
	                        <input type="radio" name="newcontract" value="0" onclick="fnewcontract(this.value)" <c:if test="${returnObject.contract.FNEWCONTRACT==0}">checked</c:if> disabled />否，旧合同续期 <span></span>
	                    </label>
	                </div>
	            </div>
	            <div class="col-md-10 col-md-offset-2">
...
<script>
	var printform = function(id){
	    $.get("../Print/Contract",{"id":id},function(jsp){
