...
<div class="page-content" style="min-height: 1147px;">
    ...
    <div class="page-base-content">
    	<div>
    		...
    		<button class="btn btn-success" onclick="$('#status').val(1);$('#form_bill').submit()">保存</button>
    	...
    	<form id="form_bill" class="form-horizontal" role="form">
    		...
    		<c:forEach items="${returnObject.entry}" var="row" varStatus="s">
				<div class="form-group">
					...
					<div class="col-md-2"><input class="form-control" name="hours" type="number" min=0 value="${row.FHOURS}" required /></div>
					<div class="col-md-3">
...
<div class="form-group" id="template" style="display: none;">
	...
	<div class="col-md-3">
		<div class="input-group date form_datetime form_datetime bs-datetime form-group-inline">
            <input type="text" size="16" class="form-control" name="endtiem" required >
            <span class="input-group-addon">
                <button class="btn default" type="button">
                    <i class="fa fa-calendar"></i>
                </button>
