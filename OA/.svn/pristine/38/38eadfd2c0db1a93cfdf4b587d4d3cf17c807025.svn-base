...
public class ProcessInstanceHighlightsResource {
	...
	@RequestMapping(value="/process-instance/{processInstanceId}/highlights", method = RequestMethod.GET)
	@ResponseBody
	public JSONObject getHighlighted(@PathVariable String processInstanceId) {
...
//			List<HistoricActivityInstance> historyhighLightedActivities = historyService.createHistoricActivityInstanceQuery().processInstanceId(processInstanceId).list();
...
//			for (HistoricActivityInstance historyactivityinstance : historyhighLightedActivities) {
//				activitiesArray.add(historyactivityinstance.getActivityId());
//			}
