...
$(function(){
    ...
    $(document).on("keyup","#list input[name='cost'],input[name='hotelprice'],input[name='hoteldays'],input[name='foodprice'],input[name='fooddays'],input[name='businessamount'],input[name='businessamount'],input[name='otheramount']",function(){
    ...
    $(document).on("change","#list input[name='cost'],input[name='hotelprice'],input[name='hoteldays'],input[name='foodprice'],input[name='fooddays'],input[name='businessamount'],input[name='businessamount'],input[name='otheramount']",function(){
    	$("input[name='hotelamount']").val(Number($("input[name='hotelprice']").val())*Number($("input[name='hoteldays']").val()));
    	$("input[name='foodamount']").val(Number($("input[name='foodprice']").val())*Number($("input[name='fooddays']").val()));
    	sum();
    });
