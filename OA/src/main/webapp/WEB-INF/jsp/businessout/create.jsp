...
<tempus:Content contentPlaceHolderId="title">
    <title><i18n:message code="公事外出申请" /></title>
    	...
    	<form id="form_bill" class="form-horizontal" role="form">
			...
			<div class="form-group">
				<div class="form-group-inline">
	        		...
	        		<div class="col-md-10"><input class="form-control" name="name" value="${USER.name}的公事外出申请" required /></div>
        		</div>
			</div>
			<div class="form-group">
        		<div class="form-group-inline">
			...
			<div id="list">
				<div class="form-group">
	        		...
	        		<div class="col-md-1" style="text-align: center;"><span class="btn green fa fa-plus" onclick="addlist()"></span></div>
	        		<div class="form-group-inline" style="margin-top: 50px;">
		        		<label class="col-md-2 control-label">公出事由<span class="required">*</span></label>
	        			<div class="col-md-9"><textarea name="cause" class="form-control" required ></textarea></div>
	        		</div>
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-2 col-md-offset-7 control-label">合计<span class="required">*</span></label>
        		<div class="col-md-2"><input id="totalhours" name="totalhours" class="form-control" value="" readonly /></div>
			</div>
    	</form>
