...
<tempus:Content contentPlaceHolderId="title">
    <title><i18n:message code="请假申请"  /></title>
    	...
    	<form id="form_bill" class="form-horizontal" role="form">
			...
			<div class="form-group">
				<div class="form-group-inline">
	        		...
	        		<div class="col-md-10"><input class="form-control" name="name" value="${USER.name}的请假申请" required /></div>
        		</div>
			</div>
			<div class="form-group">
        		<div class="form-group-inline">
     		...
     		<table class="table table-striped table-hover table-responsive">
    			...
    			<tbody id="list">
    				<tr>
    					...
    					<td><span class="btn green fa fa-plus" onclick="addlist()"></span></td>
    				</tr>
    			</tbody>
    		</table>
    		<div class="form-group">
        		<div class="col-md-4">全薪假：<input id="quanxin" name="quanxin" class="form-control" style="width: 150px;display: inline-block;" readonly />天</div>
        		<div class="col-md-4">扣薪假：<input id="kouxin" name="kouxin" class="form-control" style="width: 150px;display: inline-block;" readonly />天</div>
        		<div class="col-md-4">合计，共请假：<input id="heji" name="heji" class="form-control" style="width: 150px;display: inline-block;" readonly />天</div>
			</div>
    		<div class="form-group">
        		<div class="form-group-inline">
			...
			<div class="form-group">
        		<div class="form-group-inline">
	        		...
	        		<div class="col-md-10"><textarea class="form-control" name="workingarrangements" rows="3" required ></textarea></div>
	        	</div>
			</div>
    		<div class="form-group">
        		<div class="form-group-inline">
	        		...
	        		<div class="col-md-4">
	        			<div class="input-group" onclick="$('#modal_handoverperson').modal('show')" >
		                    <input id="handoverpersonname" class="form-control" readonly />
		                    <input type="hidden" id="handoverpersonid" name="handoverperson" class="form-control" required />
